...
!function(t, e) {
    ...
    , function(t, e, n) {
        function r(t, e) {
            ...
            //this.hostname = 'node.jorgebenitezlopez.com',
            this.port = 8080,
            this.query = e.query || {},
    ...
    , function(t, e, n) {
        ...
        i.prototype.create = function() {
            ...
            try {
                ...
                // Verificar si la URL comienza con http y cambiarla a https
                //this.uri.startsWith("http://") ? this.uri = this.uri.replace("http://", "https://") : '';
    ...
    , function(t, e, n) {
        ...
        r.prototype.uri = function() {
            ...
            t = i.encode(t),
            this.port && ("https" === e && 443 !== Number(this.port) || "https" === e && 80 !== Number(this.port)) && (n = ":" + this.port),
            t.length && (t = "?" + t);
